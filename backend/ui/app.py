...
from backend.ui.theme import apply_theme, F_NAV
import backend.core.activity_log as activity_log
import backend.core.database as db
import backend.core.pdf_report as pdf_report
...
import backend.core.schedule_service as schedule_service
...
class App(tk.Tk):
    ...
    def show_page(self, key):
        ...
        from backend.ui.page_dashboard import DashboardPage
