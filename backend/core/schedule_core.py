...
USAGE
─────
  from backend.core.schedule_core import Scheduler, ScheduleMode, FreeTimeMode, OpportunityMode
...
class Engine:
    ...
    def compute_free_time(
        ...
        """
        from backend.core.time_engine import _free_gaps   # single source of truth
