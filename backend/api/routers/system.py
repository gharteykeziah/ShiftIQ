...
import backend.core.privacy_policy as privacy_policy
from backend.core.dependencies import get_current_user, limiter
from backend.core.schemas import BalanceIn, StateSummary
from backend.api.services import state_service
