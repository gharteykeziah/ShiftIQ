...
`from api import app, limiter`, and Dockerfile/render.yaml run
`uvicorn api:app` — this file is the one guaranteed entry point.
...
from routers import auth, expenses, insights, jobs, optimizer, shifts, simulation, system
